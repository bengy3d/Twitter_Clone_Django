...
urlpatterns = [
    ...
    path('my_profile/following', MyProfileFollowingsList.as_view(), name='my_profile_following'),
    ...
    path('tweets/<uuid:pk>/likes', TweetLikeList.as_view(), name='tweet_likes_list'),
    path('comment/<uuid:pk>/likes', CommentLikeList.as_view(), name='comment_likes_list'),
